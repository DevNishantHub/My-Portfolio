...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                emailjs.send('service_ozc58ld', 'template_cew8zzh', {
                    to_name: "Nishant Kumar",
                    to: "nishantkumar211106@gmail.com",
                ...
                .then(function(response) {
                    ...
                    // Second email - confirmation to the sender
                    return emailjs.send('service_ozc58ld', 'template_scwnbuo', { // Replace with your new confirmation template ID
                        to_email: senderEmail,
                        to_name: senderName,
                        from_name: "Nishant Kumar",
                        from_email: "nishantkumar211106@gmail.com",
                        reply_to: "nishantkumar211106@gmail.com",
                        message: senderMessage,
                        current_date: currentDate
                    });
                })
                .then(function(response) {
                    ...
                    formStatus.querySelector('p').classList.add('bg-green-100', 'text-green-700');
                    formStatus.querySelector('p').classList.remove('bg-red-100', 'text-red-700');
                    formStatus.querySelector('p').textContent = 'Your message has been sent successfully!';
                ...
                .catch(function(error) {
                    ...
                    formStatus.classList.remove('hidden');
                    formStatus.querySelector('p').classList.add('bg-red-100', 'text-red-700');
                    formStatus.querySelector('p').classList.remove('bg-green-100', 'text-green-700');
                    formStatus.querySelector('p').textContent = `Failed to send your message: ${error.text || 'Please try again later.'}`;
    ...
    console.log("Current User's Login: DevNishantHub");
});
